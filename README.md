...
- jsDelivr
  ...
  ```html
  <script src="https://cdn.jsdelivr.net/npm/dynamsoft-mrz-scanner@3.1.0-beta-202601120001/dist/mrz-scanner.bundle.js"></script>
  ```

- UNPKG

  ```html
  <script src="https://unpkg.com/dynamsoft-mrz-scanner@3.1.0-beta-202601120001/dist/mrz-scanner.bundle.js"></script>
  ```

When using a framework such as **React**, **Vue** or **Angular**, we recommend adding the package as a dependency using a package manager such as **npm** or **yarn**:

```sh
npm i dynamsoft-mrz-scanner@3.1.0-beta-202601120001 -E
# or
yarn add dynamsoft-mrz-scanner@3.1.0-beta-202601120001 -E
```
